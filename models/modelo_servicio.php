...
class modelo_servicio
{
    ...
    public function contrato_servicio($id_cliente, $id_plan, $id_tipo_conexion, $id_servicio, $fecha_contrato, $acceso_cliente, $observaciones, $dias_mas, $cargo_extra)
    {
        try {
            $estado = "activo";
            $m = new modelo_mensualidad();

            // Insertar nuevo servicio (consulta corregida con dias_mas y cargo_extra)
            $sql = "INSERT INTO contratos_servicio (
                        id_cliente, id_plan, id_servicio, id_tipo_conexion, 
                        fecha_contrato, estado, acceso_cliente, observaciones, dias_mas, cargo_extra
                    ) VALUES (
                        :id_cliente, :id_plan, :id_servicio, :id_tipo_conexion, 
                        :fecha_contrato, :estado, :acceso_cliente, :observaciones, :dias_mas, :cargo_extra
                    )";
            ...
            $stmt->bindParam(':dias_mas', $dias_mas);
